...
export function useTweaks(defaults: TweakValues): [TweakValues, (key: string, val: unknown) => void] {
...
export function TweakSection({ title, children }: { title: string; children?: React.ReactNode }) {
  return (
    <>
...
export function TweakSlider({ value, onChange, min = 0, max = 100, step = 1 }: {
...
export function TweakToggle({ value, onChange }: { value: boolean; onChange: (v: boolean) => void }) {
  return (
...
export function TweakRadio({ value, onChange, options }: {
  value: string;
