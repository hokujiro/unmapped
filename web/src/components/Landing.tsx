...
type Portal = "landing" | "youth" | "employer" | "explorer";

interface Props { onPick: (p: Portal) => void; }
    ...
    <div style={{ minHeight: "100vh", background: "var(--paper)" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 14, alignItems: "center", flexWrap: "wrap" }}>
              <button className="btn btn-primary" onClick={() => onPick("youth")}>
                I'm looking for opportunities <span>→</span>
              </button>
      ...
      <section style={{ padding: "40px 28px 80px", maxWidth: 1280, margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: 14, marginBottom: 30 }}>
          <span className="mono" style={{ fontSize: 11, letterSpacing: 1.5, textTransform: "uppercase", color: "var(--ink-soft)" }}>three doors, one platform</span>
          <span style={{ flex: 1, height: 1, background: "var(--line)" }}></span>
        </div>

        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 18 }}>
          <DoorCard kind="youth"    label="01" title="I'm a young person"
            ...
            bgColor="#1f5d3a" arrowColor="var(--green)" onPick={onPick} />
          <DoorCard kind="employer" label="02" title="I'm an employer or NGO"
            ...
            bgColor="#2f6fa3" arrowColor="var(--sky)" onPick={onPick} />
          <DoorCard kind="explorer" label="03" title="I want to see the data"
            ...
            bgColor="#e26a4a" arrowColor="var(--coral)" onPick={onPick} />
        </div>
    ...
    <button onClick={() => onPick(kind)}
      ...
      <div style={{ padding: "26px 26px 28px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 14 }}>
          ...
          <span style={{ fontSize: 22, color: arrowColor }}>→</span>
        </div>
