        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 60, alignItems: "center" }}>
          ...
          <div style={{ position: "relative" }}>
            <div style={{ position: "relative", height: 540 }}>
              <div className="photo-ph green" style={{ position: "absolute", top: 0, right: 30, width: 280, height: 360, borderRadius: 200, transform: "rotate(-3deg)" }}>
                <span>[ photo: young woman, repair workshop, Accra ]</span>
              </div>
              <div className="photo-ph" style={{ position: "absolute", bottom: 60, left: 0, width: 240, height: 240, borderRadius: 24, transform: "rotate(4deg)" }}>
                <span>[ photo: hands holding circuit board ]</span>
              </div>
              <div style={{
...
function DoorCard({ kind, label, title, sub, blurb, color, photoLabel, onPick }) {
  ...
  return (
    ...
    >
      <div className="photo-ph" style={{ height: 200, borderRadius: 0, background: color === "var(--green)" ? "#1f5d3a" : color === "var(--sky)" ? "#2f6fa3" : "#e26a4a", color: "#ffffff90" }}>
