    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 18, marginBottom: 18 }}>
        <div className="card" style={{ background: "var(--green)", color: "#fff", borderRadius: 22, padding: 28, position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", right: -40, bottom: -40, width: 160, height: 160, borderRadius: 999, border: "1px solid rgba(255,255,255,0.2)" }}></div>
          <div style={{ position: "absolute", right: 10, top: 14, fontFamily: "JetBrains Mono", fontSize: 10, opacity: 0.5 }}>UM-{country}-0142</div>
        </div>
